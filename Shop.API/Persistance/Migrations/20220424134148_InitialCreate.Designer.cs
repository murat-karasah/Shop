...
namespace Shop.API.Persistance.Migrations
{
    ...
    [Migration("20220424134148_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.API.Core.Domain.Entity.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProducAmount")
                        .HasColumnType("int");

                    b.Property<decimal>("ProducPrice")
            ...
            modelBuilder.Entity("Shop.API.Core.Domain.Entity.Cart", b =>
                {
                    ...
                    b.HasOne("Shop.API.Core.Domain.Entity.Order", "Order")
                        .WithOne("Cart")
                        .HasForeignKey("Shop.API.Core.Domain.Entity.Cart", "OrderId");
            ...
            modelBuilder.Entity("Shop.API.Core.Domain.Entity.CartItem", b =>
                {
                    b.HasOne("Shop.API.Core.Domain.Entity.Cart", "Cart")
                        .WithMany("CartItems")
